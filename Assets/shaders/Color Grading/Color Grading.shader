Shader "Custom/Color Grading"
{
   Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _myColor ("Sample color", Color) = (1, 1, 1, 1) // This color will tint the graded output
        _LUT("LUT", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _Contribution;
            fixed4 _myColor; // Declare the color variable
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // Blend with _myColor to apply a tint
                float4 tintedCol = gradedCol * _myColor;
                
                // Return the blended color
                return lerp(col, tintedCol, _Contribution);
            }
            ENDCG
        }
    }
